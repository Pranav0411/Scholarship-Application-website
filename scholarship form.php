 ...
 include 'appformcon.php';
  ...
  ?>
        ...
        <ul class="list-unstyled components mb-5">
          <li class="active">
            <a href="pro.php?ema=<?php echo $res['conemail']; ?>"><span class="fa fa-home mr-3"></span> Profile</a>
          </li>
          <li>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>-->
        <h4 style="color: blue;">Guidelines for Scholarship Form</h4>
        <h5 style="color: coral;">How to apply?</h5>
          <h5>          
          Before initiating registration process, students / Parents / guardian are advised to keep the following documents handy:<br><br>
          
          1. Personal details<br>
          2. Educational qualification<br>
          3. Family income details<br>
          4. Upload documents<br><br>

          Please <a href="https://forms.gle/BnDLmeauDe4px6qk8">click here</a> to apply for the Scholarship
          </h5>
